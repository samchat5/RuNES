...
lazy_static! {
    pub static ref OPS: Vec<Op<'static>> = vec![
        ...
        Op::new(0x13, "*SLO", AddressingMode::IndirectIndexed, 8, 2),
        ...
        Op::new(0x1b, "*SLO", AddressingMode::AbsoluteY, 7, 3),
        Op::new(0x1c, "*NOP", AddressingMode::AbsoluteX, 4, 3),
        Op::new(0x1d, "ORA", AddressingMode::AbsoluteX, 4, 3),
        Op::new(0x1e, "ASL", AddressingMode::AbsoluteX, 7, 3),
        Op::new(0x1f, "*SLO", AddressingMode::AbsoluteX, 7, 3),
        // ---------------------------------------------------------------------------------------------
        ...
        Op::new(0x33, "*RLA", AddressingMode::IndirectIndexed, 8, 2),
        ...
        Op::new(0x3b, "*RLA", AddressingMode::AbsoluteY, 7, 3),
        Op::new(0x3c, "*NOP", AddressingMode::AbsoluteX, 4, 3),
        Op::new(0x3d, "AND", AddressingMode::AbsoluteX, 4, 3),
        Op::new(0x3e, "ROL", AddressingMode::AbsoluteX, 7, 3),
        Op::new(0x3f, "*RLA", AddressingMode::AbsoluteX, 7, 3),
        // ---------------------------------------------------------------------------------------------
        ...
        Op::new(0x53, "*SRE", AddressingMode::IndirectIndexed, 8, 2),
        ...
        Op::new(0x5b, "*SRE", AddressingMode::AbsoluteY, 7, 3),
        Op::new(0x5c, "*NOP", AddressingMode::AbsoluteX, 4, 3),
        Op::new(0x5d, "EOR", AddressingMode::AbsoluteX, 4, 3),
        Op::new(0x5e, "LSR", AddressingMode::AbsoluteX, 7, 3),
        Op::new(0x5f, "*SRE", AddressingMode::AbsoluteX, 7, 3),
        // ---------------------------------------------------------------------------------------------
        ...
        Op::new(0x73, "*RRA", AddressingMode::IndirectIndexed, 8, 2),
        ...
        Op::new(0x7b, "*RRA", AddressingMode::AbsoluteY, 7, 3),
        Op::new(0x7c, "*NOP", AddressingMode::AbsoluteX, 4, 3),
        Op::new(0x7d, "ADC", AddressingMode::AbsoluteX, 4, 3),
        Op::new(0x7e, "ROR", AddressingMode::AbsoluteX, 7, 3),
        Op::new(0x7f, "*RRA", AddressingMode::AbsoluteX, 7, 3),
        // ---------------------------------------------------------------------------------------------
        ...
        Op::new(0x91, "STA", AddressingMode::IndirectIndexed, 6, 2),
        ...
        Op::new(0x99, "STA", AddressingMode::AbsoluteY, 5, 3),
        Op::new(0x9a, "TXS", AddressingMode::Implicit, 2, 1),
        Op::new(0x9d, "STA", AddressingMode::AbsoluteX, 5, 3),
        // ---------------------------------------------------------------------------------------------
        ...
        Op::new(0xd3, "*DCP", AddressingMode::IndirectIndexed, 8, 2),
        ...
        Op::new(0xdb, "*DCP", AddressingMode::AbsoluteY, 7, 3),
        Op::new(0xdc, "*NOP", AddressingMode::AbsoluteX, 4, 3),
        Op::new(0xdd, "CMP", AddressingMode::AbsoluteX, 4, 3),
        Op::new(0xde, "DEC", AddressingMode::AbsoluteX, 7, 3),
        Op::new(0xdf, "*DCP", AddressingMode::AbsoluteX, 7, 3),
        // ---------------------------------------------------------------------------------------------
        ...
        Op::new(0xf3, "*ISB", AddressingMode::IndirectIndexed, 8, 2),
        ...
        Op::new(0xfb, "*ISB", AddressingMode::AbsoluteY, 7, 3),
        Op::new(0xfc, "*NOP", AddressingMode::AbsoluteX, 4, 3),
        Op::new(0xfd, "SBC", AddressingMode::AbsoluteX, 4, 3),
        Op::new(0xfe, "INC", AddressingMode::AbsoluteX, 7, 3),
        Op::new(0xff, "*ISB", AddressingMode::AbsoluteX, 7, 3),
    ];
}
